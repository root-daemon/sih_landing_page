          ...
          <div className="global-container">
            <div className="flex px-20">
              <div className="mb-14 mt-16 flex flex-col items-center lg:mb-20">
                ...
                <p className="jos slide-from-bottom mb-11 max-w-[700px] text-justify font-semibold sm:text-xl lg:text-[18px] xl:max-w-[980px]">
                  From Plans to Progress: Unified Action for India's
                  Infrastructure Growth Transform ideas into actionable plans
                  with coordinated efforts across departments to build a
                  stronger nation.
                </p>
                <div
              ...
              <div className="jos slide-from-bottom">
                <img
                  src={heroimg}
                  alt="hero-dashboard"
            ...
            <div
              className="jos hero-img overflow-hidden rounded-xl bg-black shadow-lg"
